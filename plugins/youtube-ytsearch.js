...
let handler = async (m, { conn, text, usedPrefix, command }) => {
    if (!text) return m.reply(`• *Ejemplo:* ${usedPrefix + command} TeamShining épico momentos`);
...
buttons: [
                    {"buttonParamsJson": `       [['Canal', 'https://whatsapp.com/channel/0029VaogOkQ3gvWhofzhKH10']], m);
               }
                ]
            })
        });
