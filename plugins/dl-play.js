...
let handler = async (m, { conn, command, args, text, usedPrefix }) => {
    if (!text) {
        return conn.reply(m.chat, '*Que quieres que busque Sԋιɳιɳɠ Mσσɳ 🌙*', m);
    }
    ...
    txt += '·̇·̣̇̇·̣̣̇·̣̇̇·̇┈┈┈┈┈┈┈┈┈┈┈┈┈┈·̇·̣̇̇·̣̣̇·̣̇̇·̇\n';
    ...
    await conn.sendButton2(m.chat, txt, '. ', thumbnail, [
        ...
        ], null, [['Canal', 'https://whatsapp.com/channel/0029VaogOkQ3gvWhofzhKH10']], m);
