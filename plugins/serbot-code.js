...
async function connectionUpdate(update) {
    ...
    await parent.reply(m.chat, args[0] ? 'Conectado con exito' : 'Conectado exitosamente Sub Bot de (Sԋιɳιɳɠ Mσσɳ🌙) con WhatsApp\n\n*Nota:* Esto es temporal\nSi el Bot principal se reinicia o se desactiva, todos los sub bots tambien lo haran\n\nEl número del bot puede cambiar, guarda este enlace:\n*-* https://whatsapp.com/channel/0029VaogOkQ3gvWhofzhKH10', m, rcanal)
    await sleep(5000)
    if (args[0]) return
