...
let handler = async (m, { conn, text, command, usedPrefix }) => {
  ...
  conn.sendMessage(m.chat, {
        text: `✅¡Lograste cometer tu crimen con exito!, acabas de robar *${amountTaken} 🌙 Lunas* a @${randomUserId.split("@")[0]}\n\nSe suman *+${amountTaken} 🌙 Lunas* a ${senderName}.`,
  contextInfo: { 
  ...
  conn.reply(m.chat, `❌ No fuiste cuidadoso y te atraparon mientras cometias tu cirme, se restaron *-${amountSubtracted} 🌙 Lunas* a ${senderName}.`, m)
  break
  ...
  conn.sendMessage(m.chat, {
  text: `✅ Lograste cometer tu crimen con exito, pero te descubrieron y solo lograste tomar *${smallAmountTaken} 🌙 Lunas* de @${randomUserId.split("@")[0]}\n\nSe suman *+${smallAmountTaken} 🌙 Lunas* a ${senderName}.`,
  contextInfo: { 
  mentionedJid: [randomUserId],
  }
  }, { quoted: m })
